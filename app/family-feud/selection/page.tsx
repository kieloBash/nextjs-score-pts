...
import SelectionCard from "@/components/feud/card/selection";
...
const Blank = () => {
  return (
    <div className="flex items-center justify-center w-full h-full bg-blue-700 border-4 border-black rounded-md shadow-lg shadow-yellow-800">
      <span className="font-black text-yellow-500 text-8xl">?</span>
    </div>
  );
};
