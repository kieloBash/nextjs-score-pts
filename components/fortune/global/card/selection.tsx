...
const SelectionCard = ({ name }: { name: string }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full gap-2 bg-red-700 border-4 border-black rounded-md shadow-lg shadow-red-800">
      ...
      <span className="text-2xl font-black text-green-500">{name}</span>
    </div>
  );
};
